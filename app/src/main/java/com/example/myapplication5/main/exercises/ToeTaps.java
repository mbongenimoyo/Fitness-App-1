...
public class ToeTaps implements Exercise {

    public String name="Toe taps";
    ...
    public ToeTaps(int reps, String type){
        this.reps=reps;
        this.type=type;
    }


    public ToeTaps(Integer reps, String type, Integer complete, String program, Integer routine) {
        this.reps=reps;
        this.type=type;
