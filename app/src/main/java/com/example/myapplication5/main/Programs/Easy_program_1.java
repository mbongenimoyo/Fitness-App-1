...
public class Easy_program_1 implements Program {


    public ArrayList<Routine> routines= new ArrayList<>();

    public String name="Beginner program 1";
    int thumbnail= R.drawable.easy1;

    public String TABLE_NAME="easyprogram1";
    Context c;

    public  Easy_program_1 (){

    }

    public Easy_program_1(Context context){
        c= context;
