...
public class Med_program_1 implements Program {


    public ArrayList<Routine> routines= new ArrayList<>();

    public String name="Medium program 1";
    int thumbnail= R.drawable.easy_1_image;

    public String TABLE_NAME="mediumprogram1";

    public Med_program_1(){

    }

    public Med_program_1(Context context){
