...
public class SidePlanks implements Exercise {

    public String name="Side planks";
    ...
    public SidePlanks(int reps, String type){
        this.reps=reps;
        this.type=type;
    }


    public SidePlanks(Integer reps, String type, Integer complete, String program, Integer routine) {
        this.reps=reps;
        this.type=type;
