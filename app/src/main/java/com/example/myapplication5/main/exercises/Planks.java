...
public class Planks implements Exercise {
    ...
    public Planks(int reps,String type){
        this.reps=reps;
        this.type = "seconds";
    }

    public Planks(Integer reps, Integer integer){
        this.reps=reps;
        this.type = "seconds";
    }
    ...
    public Planks(Integer reps, String type, Integer complete,String program,Integer routine) {
        this.reps=reps;
        this.type=type;
