...
public class Easy_program_2 implements Program {


    public ArrayList<Routine> routines= new ArrayList<>();

    public String name="Beginner program 2";
    int thumbnail= R.drawable.lady_at_computer;

    public String TABLE_NAME="easyprogram2";

    public Easy_program_2(){

    }

    public Easy_program_2(Context context){
