...
public class KneeToElbow implements Exercise {

    public String name="Knee to elbow";
    ...
    public KneeToElbow(int reps, String type){
        this.reps=reps;
        this.type=type;
    }


    public KneeToElbow(Integer reps, String type, Integer complete, String program, Integer routine) {
        this.reps=reps;
        this.type=type;
