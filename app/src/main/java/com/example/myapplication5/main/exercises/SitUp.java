...
public class SitUp implements Exercise {

    public String name="Sit ups";
    ...
    public SitUp(int reps, String type){
        this.reps=reps;
        this.type=type;
    }


    public SitUp(Integer reps, String type, Integer complete,String program,Integer routine) {
        this.reps=reps;
        this.type=type;
